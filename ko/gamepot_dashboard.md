...
② 기간를 선택하여 기간에 대한 그래프를 확인할 수 있습니다.
...
④ 사용여부를 체크하면 메일 알림 기능이 동작합니다.

⑤ 발신 메일 주소를 입력합니다.

⑥ 발신 메일 이름을 입력합니다.

⑦ 메일의 머리글을 입력합니다. 입력하지 않을 경우 기본 문구로 발송됩니다.

⑧ 메일의 바닥글을 입력합니다. 입력하지 않을 경우 기본 문구로 발송됩니다.
...
**외부접속 설정**을 클릭하면 외부 문의 URL이 클립보드에 저장됩니다.
