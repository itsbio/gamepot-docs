...
**+쿠폰생성**을 클릭하면 아래와 같은 팝업이 나타나고 이를 통해 쿠폰을 생성할 수 있습니다.
...
고객이 문의한 내역을 확인하실 수 있습니다. 답변 만족도는 문의 종료 후 고객이 만족도를 선택해야 노출됩니다.
...
① 담당자를 지정할 수 있습니다. 담당자를 지정하면 해당 담당자 외 다른 사용자는 문의에 답변할 수 없습니다.

② 문의 제목을 번역할 수 있습니다. 감지된 언어에서 기본 번역 언어로 번역됩니다.

③ 답변 템플릿을 선택하여 적용할 수 있습니다.

④ 작성한 답변 내용을 번역할 수 있습니다. Papago에서 지원하는 언어만 목록에 보여집니다.

⑤ 답변에 필요한 이미지 파일을 업로드 할 수 있습니다.

⑥ 문의 내역을 번역할 수 있습니다. 감지된 언어에서 기본 번역 언어로 번역됩니다.

⑦ 해당 회원에 대한 모든 정보를 기본적으로 표시합니다.

**\[알림 설정\]**

고객에게 답변을 할 경우 고객에게 푸시, 메일을 발송하는 기능입니다.

![gamepot_dashboard_47](./images/gamepot_dashboard_47.png)

① 사용여부를 체크하면 푸시알림 기능이 동작합니다.

② 디바이스 언어설정에 따라 다르게 노출되는 푸시메시지입니다.

![gamepot_dashboard_103](./images/gamepot_dashboard_103.png)

① 사용여부를 체크하면 메일알림 기능이 동작합니다.

② 발신 메일 주소를 입력합니다.

③ 발신 메일 이름을 입력합니다.

④ 발신 메일 내용을 입력합니다. 내용을 입력하지 않으면 기본 메세지로 발송됩니다.

⑤ 발송될 메일 템플릿을 미리볼 수 있습니다.

⑥ 확인 버튼으로 알림 설정, 메일 설정을 저장할 수 있습니다.
...
② WebHook 적용을 간단하게 테스트 할 수 있습니다.

③ Webhook을 통해 게임 서버 호출 시 허용 해야하는 IP 리스트를 보여줍니다.
