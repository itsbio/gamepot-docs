...
### 고객지원 BETA<a name="고객지원 BETA"></a>

고객문의, 구글 리뷰, 이용약관 등 고객지원에 관련된 모든 기능을 관리할 수 있습니다.

#### - 대시보드<a name="대시보드"></a>

문의 처리 현황, 통계 등의 고객문의의 전반적인 상황을 한눈에 파악할 수 있습니다.

#### - 고객문의<a name="고객문의"></a>

고객이 게임 내에서 문의를 남겼을 경우 조회하고 답변할 수 있습니다. 

![gamepot_dashboard_112.png](./images/gamepot_dashboard_112.png)

버튼을 클릭하여 테이블 또는 리스트 형식으로 변경이 가능합니다.

**문의 제목을 클릭하여 문의 상세 내역을 확인할 수 있습니다.**

고객문의 상세 페이지에서 해당 회원에 대한 모든 정보를 확인할 수 있습니다.

담당자 변경 내역, 문의 상태 변경 내역, 답변 등록, 사용자 ID 변경 내역의 히스토리를 확인할 수 있습니다.

답변 만족도는 문의 종료 후 고객이 만족도를 선택해야 노출됩니다.

번역 기능으로 문의 내용, 답변 내용의 언어를 감지히거나 원하는 언어로 번역할 수 있습니다.

> 고객문의 번역 기능은 프로젝트 설정>NCloud>Papago 값을 설정해야 노출됩니다. 
>
> 기본 번역 언어, 자동 언어 감지, 자동 번역 기능은 회원 정보 수정에서 설정할 수 있습니다.

#### - 통계<a name="통계3"></a>

일별, 담당자별, 분류별 통계를 확인할 수 있습니다.
...
담당자별 문의 현황, 평균 별점 등을 확인할 수 있습니다.

\+ 버튼을 클릭하여 담당자를 추가하면 해당 담당자에 대한 상세 통계를 추가할 수 있습니다.

[종합] 탭에서는 담당자로 설정된 적 있는 모든 담당자의 종합 통계를 보여줍니다.

**분류별 통계** 

분류별 문의 현황을 확인할 수 있습니다.

\+ 버튼을 클릭하여 분류를 추가하면 해당 분류에 대한 상세 통계를 추가할 수 있습니다.

[종합] 탭에서는 문의 등록된 적 있는 모든 분류의 종합 통계를 보여줍니다.
...
구글 리뷰 데이터를 대시보드에서 조회하고 답변을 등록할 수 있습니다.

구글 리뷰 기능을 사용하려면 구글 API Key 및 App ID를 필수로 입력해야 합니다.
...
복사 버튼을 클릭하면 비회원 문의 URL이 클립보드에 저장됩니다.

로그인 하지 않은 유저도 Web으로 문의를 남길 수 있습니다. 답변은 이메일로 발송됩니다.

> 비회원 문의 답변을 위해 부가정보에 이메일 템플릿을 반드시 적용해주세요.

**이용약관 페이지**

고객문의 하단 이용약관 항목에 노출될 내용을 선택합니다. 

약관 내용은 페이지 메뉴에서 설정할 수 있습니다.

**별점 사용 여부**

별점 사용 여부 비활성화 시 고객에게 별점 항목이 노출되지 않습니다.

**부가정보 설정**

이메일, 전화번호 등 추가로 입력받을 정보를 설정하여 고객 문의 항목으로 노출시킬 수 있습니다.

템플릿의 [이메일 정규식 적용]을 적용하면 입력된 이메일 형식이 올바른지 확인합니다.

문의 답변시 해당 이메일로 문의 답변이 발송되니 비회원 문의를 사용하시려면 반드시 설정해주시기 바랍니다.

#### 알림

문의 답변 시 고객에게 푸시, 메일을 발송을 설정하는 기능입니다.
...
고객문의에 대한 분류 및 템플릿을 미리 설정해놓는 기능입니다.

디바이스 언어설정에 따라 분류명과 템플릿을 지정해 놓을 수 있습니다.

이벤트 약관을 설정하면 고객문의에서 해당 분류를 선택했을때 약관창이 노출됩니다.

화살표 버튼을 클릭하여 노출될 분류의 순서를 변경할 수 있습니다.

#### 답변 템플릿

관리자의 문의 답변에 대한 템플릿을 설정할 수 있습니다.
...
디바이스 언어설정에 따라 템플릿명과 내용을 지정해 놓을 수 있습니다.

템플릿 언어는 프로젝트의 사용 언어만 설정 가능합니다.

#### 규칙

설정한 규칙에 따라 고객 문의의 담당자, 기한, 중요도 등을 자동으로 지정합니다.

규칙은 최상단부터 순서대로 적용되며 화살표 버튼을 클릭하여 규칙의 순서를 설정할 수 있습니다. 

기간을 입력하지 않으면 규칙이 항상 적용됩니다. 현재 적용중인 규칙은 [적용중] 상태로 그렇지 않으면 [사용] 또는 [미사용]으로 나타납니다.

규칙 조건이 두 개 이상일 경우 조건을 모두 만족해야 규칙 작업이 적용됩니다.

#### 꾸미기

고객문의 화면의 색상, 로고이미지 등을 변경할 수 있습니다.

#### 공지사항

고객문의 화면의 공지사항을 관리할 수 있습니다.
...
![gamepot_dashboard_113.png](./images/gamepot_dashboard_113.png)

분류 아이콘을 선택하여 FAQ 화면에 노출될 아이콘을 설정해야 합니다.
...
\[Web 접속 주소\]를 클릭하면 이용약관을 웹페이지에서 확인할 수 있도록 URL이 복사됩니다. 다른 언어로 접속하려면 URL뒤에 <b><i>&language=ko</i> (ISO 639-1 코드 참고)</b>를 추가합니다.

#### 개인정보 취급 방침 설정<a name="개인정보취급방침설정"></a>

사내 개인정보 취급 방침 내용을 입력할 수 있습니다. 이 내용은 SDK를 통해 사용자에게 노출 할 수 있습니다.

\[Web 접속 주소\]를 클릭하면 개인정보 취급 방침을 웹페이지에서 확인할 수 있도록 URL이 복사됩니다. 다른 언어로 접속하려면 URL뒤에 <b><i>&language=ko</i> (ISO 639-1 코드 참고)</b>를 추가합니다.

#### 환불정책 설정<a name="환불정책설정"></a>

사내 환불정책 내용을 입력할 수 있습니다. 이 내용은 SDK를 통해 사용자에게 노출 할 수 있습니다.

\[Web 접속 주소\]를 클릭하면 환불정책을 웹페이지에서 확인할 수 있도록 URL이 복사됩니다. 다른 언어로 접속하려면 URL뒤에 <b><i>&language=ko</i> (ISO 639-1 코드 참고)</b>를 추가합니다.
...
> GDPR을 사용하기 위해 [이메일 인증] 항목에 반드시 값이 있어야 합니다.
...
④ 현재 페이지의 필수 확인 여부를 선택할 수 있습니다.

GDPR을 활성화하면 기존 이용약관, 개인정보처리방침이 GDPR 설정 내용으로 대체됩니다.

GDPR 설정에서 광고 앱 동의 활성화 여부를 선택할 수 있습니다. [개인 맞춤광고 보기에 대한 동의], [개인 맞춤이 아닌 광고 보기에 대한 동의] 항목은 이 항목이 선택되어 있어야 노출됩니다.
...
- 아이템 이름과 ID를 입력합니다. 아이템 ID는 아이템마다 고유해야 합니다.

- 대시보드 사용자의 실수를 방지할 아이템 지급 최대 수량을 지정할 수 있습니다.
