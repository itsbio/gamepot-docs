...
| 예약어                            | 필수 | 타입   | Max Length | 설명         |
| :-------------------------------- | :--- | :----- | :--------- |  :----------- |
| GamePotSendLogCharacter.NAME      | 필수 | String | 128        | 케릭터명     |
| GamePotSendLogCharacter.LEVEL     | 선택 | String | 128        | 레벨         |
| GamePotSendLogCharacter.SERVER_ID | 선택 | String | 128        | 서버아이디   |
| GamePotSendLogCharacter.PLAYER_ID | 선택 | String | 128        | 케릭터아이디 |
| GamePotSendLogCharacter.USERDATA  | 선택 | String | 128        | ETC          |
