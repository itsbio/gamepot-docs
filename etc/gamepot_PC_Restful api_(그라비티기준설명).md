...
url  주소는 게임팟 대시보드가 어디에 기반으로 두었는지에 따라 달라집니다. 

하기 가이드는 그라비티 PC 프로젝트에 전달된 내용으로 탈퇴 유예기능은 그라비티에 쪽에만 되어 있으며 기타 업체에는 없는 기능으로 안내

그라비티 한국 매니지드 : https://gravity-api.gamepot.io
한국리전 V2-real 대시보드 : https://gamepot.apigw.ntruss.com/gpapps/v1
...
![email_templates_setting](./image/email_templates.png)
