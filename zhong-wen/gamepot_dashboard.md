...
![gamepot-1-201](../.gitbook/assets/gamepot-1-201%20%282%29.png)

대시보드 이용할 계정을 생성합니다. 초기에 생성된 계정은 자동으로 마스터로 지정됩니다.

![gamepot-1-202](../.gitbook/assets/gamepot-1-202%20%285%29.png)
...
![gamepot-1-203](../.gitbook/assets/gamepot-1-203%20%282%29.png)
...
![gamepot-1-204](../.gitbook/assets/gamepot-1-204%20%283%29.png)
...
![gamepot-1-205](../.gitbook/assets/gamepot-1-205%20%282%29.png)
...
![gamepot-1-206](../.gitbook/assets/gamepot-1-206%20%283%29.png)

이후 다음과 같은 팝업 메뉴가 나타나면 원하는 값을 입력하고 **저장** 버튼을 클릭하면 공지가 추가됩니다.

![gamepot-1-207](../.gitbook/assets/gamepot-1-207%20%285%29.png)
...
![gamepot-1-500](../.gitbook/assets/gamepot-1-500%20%281%29.png)
...
![gamepot-1-208](../.gitbook/assets/gamepot-1-208%20%285%29.png)
...
![gamepot-1-209](../.gitbook/assets/gamepot-1-209%20%283%29.png)
...
![gamepot-1-210](../.gitbook/assets/gamepot-1-210%20%282%29.png)
...
![gamepot-1-210a](../.gitbook/assets/gamepot-1-210a%20%283%29.png)
...
![gamepot-1-210B](../.gitbook/assets/gamepot-1-210b%20%281%29.png)
...
![gamepot-1-210C](../.gitbook/assets/gamepot-1-210c%20%281%29.png)
...
![gamepot-1-218D](../.gitbook/assets/gamepot-1-218d%20%284%29.png)
...
![gamepot-1-221](../.gitbook/assets/gamepot-1-221%20%284%29.png)
...
![gamepot-1-239](../.gitbook/assets/gamepot-1-239%20%284%29.png)
...
![gamepot-1-239B](../.gitbook/assets/gamepot-1-239b%20%281%29.png)

① 임의적으로 구글 결제를 취소하는 회원의 게임 접속에 대해서, 일정 조건을 설정하여 이용정지 조치를 할 수 있습니다.

![gamepot-1-239C](../.gitbook/assets/gamepot-1-239c%20%283%29.png)
...
![gamepot-1-211](../.gitbook/assets/gamepot-1-211%20%282%29.png)

① SENS와 연동하기 위해서는 우선 서비스 키를 발급해야 합니다. **서비스 키 발급** 버튼을 클릭하고 [SENS 공통 가이드](https://github.com/itsbio/gamepot-docs/tree/01adc6133c1a2fc551dcae9d4258f0bbb23a35c0/sens/sens-1-2.md)를 참고하여 서비스 키를 발급 받습니다.
...
![gamepot-1-214](../.gitbook/assets/gamepot-1-214%20%284%29.png)
...
① SENS와 연동하기 위해서는 우선 서비스 키를 발급과 발신번호 등록을 해야 합니다. **서비스 키 발급** 버튼을 클릭하여 [SENS 공통 가이드](https://github.com/itsbio/gamepot-docs/tree/01adc6133c1a2fc551dcae9d4258f0bbb23a35c0/sens/sens-1-2.md)와 [SENS SMS 사용 가이드](https://github.com/itsbio/gamepot-docs/tree/01adc6133c1a2fc551dcae9d4258f0bbb23a35c0/sens/sens-1-3.md)를 참고하여 서비스 키 발급과 발신 번호를 등록합니다.

② **설정** 버튼을 클릭하여 서비스 ID와 Secret Key를 입력하여 주세요.

![gamepot-1-216](../.gitbook/assets/gamepot-1-216%20%284%29.png)

**메시지 추가** 버튼을 클릭합니다. 아래와 같은 팝업이 노출됩니다.

![gamepot-1-217](../.gitbook/assets/gamepot-1-217%20%285%29.png)
...
![gamepot-1-222](../.gitbook/assets/gamepot-1-222%20%285%29.png)

**회원 ID**를 클릭합니다.

![gamepot-1-223](../.gitbook/assets/gamepot-1-223%20%283%29.png)
...
![gamepot-1-224](../.gitbook/assets/gamepot-1-224%20%284%29.png)
...
![gamepot-1-225](../.gitbook/assets/gamepot-1-225%20%284%29.png)

쿠폰의 현재 상태와 사용량 제한수량 등을 확인하실 수 있습니다.

리스트에서 기존에 생성된 쿠폰 수량을 변경할 수 있어 손쉽게 쿠폰 수량을 증가시킬 수 있습니다.

![gamepot-1-226](../.gitbook/assets/gamepot-1-226%20%284%29.png)
...
![gamepot-1-227](../.gitbook/assets/gamepot-1-227%20%285%29.png)
...
![gamepot-1-228](../.gitbook/assets/gamepot-1-228%20%285%29.png)

#### 아이템

아이템 메뉴에서는 쿠폰을 통해 획득 가능한 쿠폰 아이템을 생성할 수 있는 메뉴입니다. **아이템 추가** 버튼을 클릭하여 아이템을 추가할 수 있습니다.

![gamepot-1-229](../.gitbook/assets/gamepot-1-229%20%284%29.png)
...
![gamepot-1-230](../.gitbook/assets/gamepot-1-230%20%284%29.png)
...
![gamepot-1-231](../.gitbook/assets/gamepot-1-231%20%282%29.png)
...
![gamepot-1-232](../.gitbook/assets/gamepot-1-232%20%281%29.png)

**추가** 버튼을 클릭합니다. 아래와 같은 팝업 창이 노출되면, 매개변수와 값을 입력합니다.

![gamepot-1-233](../.gitbook/assets/gamepot-1-233%20%284%29.png)
...
![gamepot-1-234a](../.gitbook/assets/gamepot-1-234a%20%281%29.png)
...
![gamepot-1-234b](../.gitbook/assets/gamepot-1-234b%20%284%29.png)
...
![gamepot-1-234c](../.gitbook/assets/gamepot-1-234c%20%284%29.png)
...
![gamepot-1-234d](../.gitbook/assets/gamepot-1-234d%20%283%29.png)
...
![gamepot-1-234e](../.gitbook/assets/gamepot-1-234e%20%284%29.png)

WebHook 항목에 Purchase는 결제 성공 시 아이템 지급을 요청하는 주소를 입력합니다.

URL은 SDK를 이용하여 아이템 결제 및 쿠폰 사용 성공시 SDK 서버에서 개발사 서버로 성공에 대한 처리\(아이템 지급\)를 요청하는 주소이며, 실 서비스에 이용되는 주소\(Production\)과 서비스 중 테스트 환경이 필요한 경우의 주소\(Sandbox\)가 제공됩니다. Sandbox 주소로 동작하게 하려면 '프로젝트 설정 &gt; 테스트 사용자'에 추가해 주셔야 합니다.
...
![gamepot-1-235](../.gitbook/assets/gamepot-1-235%20%282%29.png)
...
![gamepot-1-240](../.gitbook/assets/gamepot-1-240%20%282%29.png)

**추가** 버튼을 클릭합니다. 아래와 같은 팝업 창이 노출되면, 매개변수와 값을 입력합니다.

![gamepot-1-241](../.gitbook/assets/gamepot-1-241%20%284%29.png)
...
![gamepot-1-239C](../.gitbook/assets/gamepot-1-239c%20%286%29.png)

### 회원정보수정

대시보드 이용 계정의 이름, 비밀번호를 변경하실 수 있습니다.

![gamepot-1-237](../.gitbook/assets/gamepot-1-237%20%281%29.png)

① 대시보드 우측 상단의 아이콘을 클릭하면 드롭다운 메뉴가 나타납니다.

![gamepot-1-238](../.gitbook/assets/gamepot-1-238%20%284%29.png)
...
![gamepot-1-504](../.gitbook/assets/gamepot-1-504%20%284%29.png)
...
![gamepot-1-502](../.gitbook/assets/gamepot-1-502%20%284%29.png)

#### 시스템

현재 디스크 상태와 백업 현황을 파악하실 수 있습니다. 마지막 백업 시간을 확인하실 수 있습니다.

![gamepot-1-503](../.gitbook/assets/gamepot-1-503%20%284%29.png)
