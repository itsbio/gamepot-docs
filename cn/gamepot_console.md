...
![gamrpot-1-101](./images/gamrpot-1-101%20%281%29.png)

① 콘솔에서 **Game &gt; GAMEPOT**을 선택합니다.

![gamrpot-1-102](./images/gamrpot-1-102%20%282%29.png)

② **+프로젝트 생성** 버튼을 클릭합니다.

![gamrpot-1-103](./images/gamrpot-1-103%20%282%29.png)
...
![gamrpot-1-104](./images/gamrpot-1-104%20%282%29.png)

⑤ **프로젝트 생성** 버튼을 클릭하여 프로젝트 생성을 완료하세요.

* 게임 클러스터 인프라가 구성되기까지 수 분이 소요됩니다.

![gamrpot-1-112](./images/gamrpot-1-112%20%283%29.PNG)
