...
![gamepot-1-201](.gitbook/assets/gamepot-1-201%20%281%29.png)

대시보드 이용할 계정을 생성합니다. 초기에 생성된 계정은 자동으로 마스터로 지정됩니다.

![gamepot-1-202](.gitbook/assets/gamepot-1-202%20%283%29.png)
...
![gamepot-1-203](.gitbook/assets/gamepot-1-203%20%283%29.png)
...
![gamepot-1-208](.gitbook/assets/gamepot-1-208%20%283%29.png)
...
![gamepot-1-209](.gitbook/assets/gamepot-1-209%20%282%29.png)
...
![gamepot-1-210a](.gitbook/assets/gamepot-1-210a%20%282%29.png)
...
![gamepot-1-218D](.gitbook/assets/gamepot-1-218d%20%281%29.png)
...
![gamepot-1-205](.gitbook/assets/gamepot-1-205%20%283%29.png)
...
![gamepot-1-207](.gitbook/assets/gamepot-1-207%20%282%29.png)
...
![gamepot-1-230](.gitbook/assets/gamepot-1-230%20%283%29.png)
...
![gamepot-1-211](.gitbook/assets/gamepot-1-211%20%283%29.png)

① SENS와 연동하기 위해서는 우선 서비스 키를 발급해야 합니다. **서비스 키 발급** 버튼을 클릭하고 [SENS 공통 가이드](https://github.com/itsbio/gamepot-docs/tree/7cf2f082b5ef07876a2261c2e6232b7e4ba1b79d/sens/sens-1-2.md)를 참고하여 서비스 키를 발급 받습니다.

② **인증서 등록 가이드** 버튼을 클릭하여 **SENS 웹 콘솔 사용 가이드**에 따라 인증서를 등록합니다.

③ **설정** 버튼을 클릭하여 아래의 화면으로 이동하여 PUSH 서비스 ID 값을 입력합니다.

![gamepot-1-212](.gitbook/assets/gamepot-1-212%20%281%29.png)

#### 푸시메시지

**메시지 &gt; 푸시 메시지** 메뉴를 클릭하면 발송 상태, 예약 시간, 발송 시간 등을 확인할 수 있는 목록 화면이 나타납니다.

![gamepot-1-213](.gitbook/assets/gamepot-1-213%20%282%29.png)
...
① SENS와 연동하기 위해서는 우선 서비스 키를 발급과 발신번호 등록을 해야 합니다. **서비스 키 발급** 버튼을 클릭하여 [SENS 공통 가이드](https://github.com/itsbio/gamepot-docs/tree/7cf2f082b5ef07876a2261c2e6232b7e4ba1b79d/sens/sens-1-2.md)와 [SENS SMS 사용 가이드](https://github.com/itsbio/gamepot-docs/tree/7cf2f082b5ef07876a2261c2e6232b7e4ba1b79d/sens/sens-1-3.md)를 참고하여 서비스 키 발급과 발신 번호를 등록합니다.

② **설정** 버튼을 클릭하여 서비스 ID와 Secret Key를 입력하여 주세요.

![gamepot-1-216](.gitbook/assets/gamepot-1-216%20%282%29.png)

**메시지 추가** 버튼을 클릭합니다. 아래와 같은 팝업이 노출됩니다.

![gamepot-1-217](.gitbook/assets/gamepot-1-217%20%281%29.png)
...
![gamepot-1-224](.gitbook/assets/gamepot-1-224%20%282%29.png)
...
![gamepot-1-226](.gitbook/assets/gamepot-1-226%20%282%29.png)
...
![gamepot-1-227](.gitbook/assets/gamepot-1-227%20%282%29.png)
...
아이템 메뉴에서는 쿠폰을 통해 획득 가능한 쿠폰 아이템을 생성할 수 있는 메뉴입니다. **아이템 추가** 버튼을 클릭하여 아이템을 추가할 수 있습니다. ![gamepot-1-229A](.gitbook/assets/gamepot-1-229a%20%281%29.png)

① 아이템을 추가 할 수 있습니다.

② **다량입력** 버튼을 클릭하면 아이템을 CSV 파일로 한번에 등록할 수 있습니다.

![gamepot-1-229](.gitbook/assets/gamepot-1-229%20%282%29.png)
...
![gamepot-1-222](.gitbook/assets/gamepot-1-222%20%283%29.png)

**회원 ID**를 클릭합니다.

![gamepot-1-223](.gitbook/assets/gamepot-1-223%20%282%29.png)
...
![gamepot-1-223a](.gitbook/assets/gamepot-1-223a%20%281%29.png)
...
![gamepot-1-501a](.gitbook/assets/gamepot-1-501a%20%281%29.png)
...
![gamepot-1-234a](.gitbook/assets/gamepot-1-234a%20%282%29.png)
...
![gamepot-1-234e](.gitbook/assets/gamepot-1-234e%20%281%29.png)
...
![gamepot-1-236](.gitbook/assets/gamepot-1-236%20%281%29.png)
...
![gamepot-1-241](.gitbook/assets/gamepot-1-241.png)

### 로그

로그는 NAVER CLOUD PLATFORM의 ELSA를 연동하여 게임 내 로그나 크래시 로그 등을 수집하실 수 있는 기능입니다. ELSA의 사용법은 [ELSA 이용 가이드](https://github.com/itsbio/gamepot-docs/tree/7cf2f082b5ef07876a2261c2e6232b7e4ba1b79d/elsa/elsa-1-1.md)를 참고하세요.
...
![gamepot-1-238](.gitbook/assets/gamepot-1-238%20%282%29.png)
...
![gamepot-1-503](.gitbook/assets/gamepot-1-503%20%282%29.png)
